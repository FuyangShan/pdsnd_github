...
def user_stats(df):
    ...
    subsc = df.query('user_type == "Subscriber"').user_type.count()
    custo = df.query('user_type == "Customer"').user_type.count()
    print('There are {} Subscribers and {} Customers.'.format(subsc, custo))
